...
class Solution:
    def ladder_length(self, begin_word: str, end_word: str, word_list: List[str]) -> int:
        word_set = dict((word, True) for word in word_list)
        ...
        while queue:
            ...
            for i in range(n):
                ...
                if cur_word in word_set:
                    del word_set[cur_word]
                for j in range(word_len):
                    for k in range(26):
                        new_word = cur_word[:j] + chr(ord('a') + k) + cur_word[j + 1:]
...
if __name__ == '__main__':
    ...
    print(sol.ladder_length("sand", "acne",
                            ["slit", "bunk", "wars", "ping", "viva", "wynn", "wows", "irks", "gang",
                             ...
                             "rest", "lame"]))
    print(
        sol.ladder_length("talk", "tail", ["talk", "tons", "fall", "tail", "gale", "hall", "negs"]))
    print(sol.ladder_length("hot", "dog", ["hot", "dog"]))
    print(sol.ladder_length(begin_word, end_word, word_list))
    print(sol.ladder_length(begin_word, end_word, ["hot", "dot", "dog", "lot", "log"]))
