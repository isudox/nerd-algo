...
if __name__ == '__main__':
    ...
    # parse0('/Users/zhangjian/Downloads/fix_detail.csv', '/Users/zhangjian/Downloads/fix.sql', sql)

    fmt = '''
        "BizTransNo": "{0}",
        "UserId": "{1}",
    '''
    parse0('/Users/zhangjian/Downloads/req.txt', '/Users/zhangjian/Downloads/req.json', fmt)
